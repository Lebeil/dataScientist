...
# Combien y a-t-il de journalistes dans ce array ? 379
puts "nombre de journalistes:"
    puts "combien de journalistes:"
    puts journalists.length
puts "___"

# Combien d'handle contiennent un numéro ?
puts "___"
    puts "nombre d'handle contiennent un numéro:"
    puts journalists.grep(/[0-9]/).count
puts "___"

# Combien d'handle contiennent les 4 lettres du prénom "Aude" à la suite (sans prendre en compte les majuscules) ? 3
puts "___"
    puts "le nombre d'Aude:"
    puts journalists.grep(/[Aa]ude/).count
puts "___"

# Combien commencent par une majuscule (première lettre juste après le @) ?
puts "___"
    puts "nombre commencant par une majuscule:"
    puts journalists.count { |x| x[/^@\p{Upper}/] }
puts "___"

# Combien contiennent au moins une majuscule ?
puts "___"
    puts "nombre contenant au moins une majuscule:"
    puts journalists.count {|x| x[/\p{Upper}/]}
puts "___"

# Combien y a-t-il de underscore _ dans tous les pseudos confondus ?
puts "___"
    puts "nombre d'underscore:"
    puts journalists.to_s.count("_")
puts "___"
...
puts "___"
    puts "les 50 handles:"
    journalists = journalists.sort_by {|x| x.length}
    puts journalists [0..49]
puts "___"

# Quelle est la position dans l'array de la personne @epenser ?
puts "___"
    puts "position dans l'array:"
